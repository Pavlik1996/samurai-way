...
export type ActionsTypeProfile =
  ...
  | ReturnType<typeof setUserProfileSuccsses>;
...
export const setUserProfileSuccsses = (profile: ProfileInfoType) => {
  return {
...
export const setUserProfile = (userId: string) => {
  return (dispatch: Dispatch<ActionsTypeProfile>) => {
    userAPI.getMe(userId).then((data) => {
      dispatch(setUserProfileSuccsses(data));
    });
  };
};
